...
if [ $ip_address ] && [ $machine_name ]; then
    iconT="󰯐 "
    echo "<txt><span weight='Bold' fgcolor='Red'><i>$iconT</i></span><span weight='Bold' fgcolor='Cyan'><i>$ip_address</i></span> - <span weight='Bold' fgcolor='LightGray'><i>$machine_name</i></span></txt>"
else
    noTar="󰈉 "
    Ntarget="No target"
